export default function Footer() {
    ...
    return (
      <footer className="bg-white/80 backdrop-blur-sm dark:bg-gray-900/80 border-t border-gray-200 dark:border-gray-800">
        <div className="mx-auto max-w-7xl px-4 py-8 md:flex md:items-center md:justify-between lg:px-8">
          ...
          <div className="mt-8 md:order-1 md:mt-0">
            <p className="text-center text-xs leading-5 text-gray-500">
              &copy; {currentYear} QuizApp. Tous droits réservés.
            </p>
          </div>
        </div>
      </footer>
